...
Because I wanted multiple tabs, but wanted to make sure each tab worked properly, first I created two separate shiny apps.
...
This shiny app aims to show how multiverse analysis works, by setting up the decision space, where all possible analytical paths are mapped, 
and then calculating the sentitivity of each decision based on the distributions of the outcomes of each universe.