...
kable(
  ...
  kable_styling(
   ...
   footnote(
    general = "\\\\small{Reps = repetitions; lower = least nr. of reps before obeying; upper = highest nr. of reps before obeying}",
    general_title = "",
    escape = FALSE)
...
ggplot(DogData, aes(x = Category, y = reps_lower, fill = Category)) + 
  ...
  labs(x = "Dog Category", y = "Least Number of Repetitions Before Obeying")
...
For a nice overview of the intelligence of different breeds, see [this website](https://informationisbeautiful.net/visualizations/best-in-show-whats-the-top-data-dog/) [@beautiful_best_2026].
